...
export interface ChromeSpec {
  ...
  dock: { bottomOffset: number; height: number; iconSize: number; iconRadius: number };
...
const IPHONE_14: ChromeSpec = {
  ...
  dock: { bottomOffset: 0.064, height: 0.112, iconSize: 0.15, iconRadius: 0.225 },
  lockShortcuts: true,
  clockYFactor: 0.175,
...
const PIXEL_8_PRO: ChromeSpec = {
  ...
  dock: { bottomOffset: 0.064, height: 0.1, iconSize: 0.13, iconRadius: 0.25 },
  lockShortcuts: false,
  clockYFactor: 0.16,
...
const IPHONE_SE: ChromeSpec = {
  ...
  homeIndicator: null,
  dock: { bottomOffset: 0.06, height: 0.11, iconSize: 0.15, iconRadius: 0.225 },
  lockShortcuts: false,
  clockYFactor: 0.2,
  clockSizeFactor: 0.1,
};
...
const IPAD: ChromeSpec = {
  ...
  homeIndicator: null,
  dock: { bottomOffset: 0.05, height: 0.09, iconSize: 0.09, iconRadius: 0.22 },
  lockShortcuts: false,
  clockYFactor: 0.18,
  clockSizeFactor: 0.1,
};
...
const GALAXY_TAB: ChromeSpec = {
  ...
  statusBarRightInset: 0.04,
  homeIndicator: null,
  dock: { bottomOffset: 0.05, height: 0.09, iconSize: 0.09, iconRadius: 0.25 },
  lockShortcuts: false,
  clockYFactor: 0.18,
  clockSizeFactor: 0.1,
};
...
const DESKTOP: ChromeSpec = {
  ...
  statusBarRightInset: 0.04,
  homeIndicator: null,
  dock: { bottomOffset: 0.06, height: 0.1, iconSize: 0.12, iconRadius: 0.22 },
  lockShortcuts: false,
  clockYFactor: 0.18,
  clockSizeFactor: 0.1,
};
...
const WATCH: ChromeSpec = {
  ...
  statusBarRightInset: 0.06,
  homeIndicator: null,
  dock: { bottomOffset: 0.06, height: 0.1, iconSize: 0.14, iconRadius: 0.3 },
  lockShortcuts: false,
  clockYFactor: 0.22,
