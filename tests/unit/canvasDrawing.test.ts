...
function scene(overrides: Partial<EditorScene> = {}): EditorScene {
  return {
    ...
    screen: { enabled: false, style: "lock", theme: "dark", showStatusBar: true, showClock: true, showDate: true, showNotifications: false, showDock: true, showHomeIndicator: true, time: "9:41", date: "Tuesday, August 4" },
    ...overrides
  };
}
